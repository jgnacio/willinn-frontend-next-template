...
COPY --from=build --chown=nextjs:nextjs /usr/src/app/.next/standalone ./
COPY --from=build --chown=nextjs:nextjs /usr/src/app/.next/static ./.next/static
COPY --from=deps --chown=node:nextjs /usr/src/app/node_modules ./node_modules 
